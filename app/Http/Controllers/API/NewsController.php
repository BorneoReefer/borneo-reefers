...
class NewsController extends Controller
{
     ...
     *     "data": {
     *         [
     *             {"id": 1, "title": "News 1", "data": "Content here.", "created_at": "-", "updated_at": "-"},
     *             {"id": 2, "title": "News 2", "data": "Content here.", "created_at": "-", "updated_at": "-"},
     *             {"id": 3, "title": "News 3", "data": "Content here.", "created_at": "-", "updated_at": "-"}
     *         ]
     *     }
     * }
     * ```
     ...
     * ```
     * {
     *     "data": {"id": 1, "title": "News 1", "data": "Content here.", "created_at": "-", "updated_at": "-"}
     * }
     * ```
     *
